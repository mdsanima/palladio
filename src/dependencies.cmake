...
elseif(PLD_LINUX)
	if(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 8.2)
		set(PLD_CONAN_PROFILE "${PLD_CONAN_TOOLS}/profiles/linux-gcc82")
	elseif(CMAKE_CXX_COMPILER_VERSION VERSION_GREATER_EQUAL 6.3)
